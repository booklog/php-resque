...
class Test_Job extends Resque_Job_Base
{
...
class Failing_Job extends Resque_Job_Base
{
	public function perform()
	{
 ...
 */
class InProgress_Job extends Resque_Job_Base
{
	public function perform()
	{
...
class Test_Job_Without_Perform_Method extends Resque_Job_Base
{

}

class Test_Job_With_SetUp extends Resque_Job_Base
{
	public static $called = false;
	public $args = false;
...
class Test_Job_With_TearDown extends Resque_Job_Base
{
	public static $called = false;
	public $args = false;
...
class Test_Infinite_Recursion_Job extends Resque_Job_Base
{
    public function perform()
    {
        $this->perform();
